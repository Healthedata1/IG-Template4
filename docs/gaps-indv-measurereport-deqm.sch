...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    <sch:title>MeasureReport.evaluatedResource.extension</sch:title>
    <sch:rule context="f:MeasureReport/f:evaluatedResource/f:extension">
  ...
  <sch:pattern>
    <sch:title>MeasureReport.evaluatedResource.reference</sch:title>
    <sch:rule context="f:MeasureReport/f:evaluatedResource/f:reference">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>MeasureReport.evaluatedResource.type</sch:title>
    <sch:rule context="f:MeasureReport/f:evaluatedResource/f:type">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>MeasureReport.evaluatedResource.identifier</sch:title>
    <sch:rule context="f:MeasureReport/f:evaluatedResource/f:identifier">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>MeasureReport.evaluatedResource.display</sch:title>
    <sch:rule context="f:MeasureReport/f:evaluatedResource/f:display">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
</sch:schema>
